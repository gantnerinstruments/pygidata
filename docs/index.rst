...
GIModules is a Python wrapper the Gantner Instruments Cloud and QCore APIs.

It simplifies access to the Gantner measurements by providing an interface that encapsulates the underlying
